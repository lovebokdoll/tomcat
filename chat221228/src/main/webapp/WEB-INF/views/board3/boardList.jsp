...
<script type="text/javascript">
   ...
   function getBoardList() {
      ...
      //사용자가 선택한 콤보박스에 value가 담김 - bm_title, or bm_content or bm_writer
      cb_value = user_combo;
...
<body>
  ...
  <center>
    ...
    <div id="tb" style="padding: 2px 5px;">
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 작성일:
      <input id="db_date" class="easyui-datebox" name="bm_date" style="width: 110px">
      <!-- 버튼 추가 화면 시작 -->
    ...
    <div style="display: table-cell; vertical-align: middle; width: 800px; background: #efefef; height: 30; border: 1px solid #ccc;">
      ...
      PageBar pagebar = new PageBar(numPerPage, size, nowPage, pagePath);
      // 페이징 처리에 필요한 a 태그들에 대한 문자열을 만들어서 getPageBar()메서드를 호출하면
      // 페이징 처리에 필요한 문자열을 StringBuilder에 처리하였고 그 문자열을 toString()읽어와서 출력해줌
      out.print(pagebar.getPageBar());
      %>
    </div>
    <!-- 페이지 네이션 추가   끝  -->
    <%
    ...
    %>
    <!-- 글입력 화면 추가 시작 -->
    <div id="dlg_boardIns" footer="#tb_boardIns" class="easyui-dialog" title="글쓰기" data-options="modal:true,closed:true"
      ...
      <form id="f_boardIns" method="post" enctype="multipart/form-data" action="./boardInsert.st3">
        ...
        <table>
          <tr>
            ...
            <td width="500px">
              <input id="bm_title" name="bm_title" class="easyui-textbox" data-options="width:'250px'" required>
            </td>
          </tr>
          <tr>
            <td width="100px">작&nbsp;성&nbsp;자</td>
            <td width="500px">
              <input id="bm_writer" name="bm_writer" class="easyui-textbox" data-options="width:'150px'" required>
            </td>
          </tr>
          <tr>
            <td width="100px">내&nbsp;&nbsp;&nbsp;용</td>
            <td width="500px">
              <input id="bm_content" name="bm_content" class="easyui-textbox" data-options="multiline:'true',width:'350px', height:'90px'" required>
            </td>
          </tr>
          <tr>
            <td width="100px">비&nbsp;&nbsp;&nbsp;번</td>
            <td width="500px">
              <input id="bm_pw" name="bm_pw" class="easyui-textbox" data-options="width:'100px'" required>
            </td>
          </tr>
          <tr>
            <td width="100px">첨부파일</td>
            <td width="500px">
              <input id="bs_file" name="bs_file" class="easyui-filebox" data-options="width:'350px'">
            </td>
          </tr>
        </table>
      </form>
